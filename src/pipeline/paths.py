...
def discover_input_csv(data_dir: Path) -> Path:
    excluded_suffixes = (
        ...
        "_etf_returns",
        "_portfolio_returns",
        "_gross_portfolio_returns",
        "_turnover",
        "_transaction_costs",
        "_overlay_exposures",
        "_overlay_recent_drawdowns",
        "_overlay_good_probabilities",
        "_overlay_actions",
        "_weights",
        "_predictions",
        "_strategy_metrics",
...
def derive_backtest_paths(input_csv: Path, output_dir: Path) -> dict[str, Path]:
    ...
    return {
        ...
        "gross_portfolio_returns": output_dir / f"{stem}_gross_portfolio_returns.csv",
        "turnover": output_dir / f"{stem}_turnover.csv",
        "transaction_costs": output_dir / f"{stem}_transaction_costs.csv",
        "overlay_exposures": output_dir / f"{stem}_overlay_exposures.csv",
        "overlay_recent_drawdowns": output_dir / f"{stem}_overlay_recent_drawdowns.csv",
        "overlay_good_probabilities": output_dir / f"{stem}_overlay_good_probabilities.csv",
        "overlay_actions": output_dir / f"{stem}_overlay_actions.csv",
